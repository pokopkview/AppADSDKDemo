 ...
 * {@link #getCacheKey()}. </p>
 *
 * <p> This class can also optionally wrap {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.Headers} for convenience. </p>
 */
public class GlideUrl {
    private static final String ALLOWED_URI_CHARS = "@#&=*+-_.,:!?()/~'%";

    private final URL url;
    private final ad.joyplus.com.myapplication.AppUtil.glide.load.model.Headers headers;
    ...
    public GlideUrl(URL url) {
        this(url, ad.joyplus.com.myapplication.AppUtil.glide.load.model.Headers.DEFAULT);
    }
    ...
    public GlideUrl(URL url, ad.joyplus.com.myapplication.AppUtil.glide.load.model.Headers headers) {
        if (url == null) {
    ...
    public GlideUrl(String url, ad.joyplus.com.myapplication.AppUtil.glide.load.model.Headers headers) {
