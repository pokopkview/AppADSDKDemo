...
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.transcode.BitmapBytesTranscoder;
...
public class BitmapTypeRequest<ModelType> extends BitmapRequestBuilder<ModelType, Bitmap> {
    ...
    private static <A, R> FixedLoadProvider<A, ImageVideoWrapper, Bitmap, R> buildProvider(ad.joyplus.com.myapplication.AppUtil.glide.Glide glide,
