...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transforms each frame of the GIF using {@link ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(BitmapTransformation...)
     * @see #transformFrame(Transformation[])
