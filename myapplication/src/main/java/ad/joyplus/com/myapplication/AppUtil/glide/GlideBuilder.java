...
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.bitmap_recycle.LruBitmapPool;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.cache.DiskCache;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.cache.LruResourceCache;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.cache.MemoryCache;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.cache.MemorySizeCalculator;
import ad.joyplus.com.myapplication.AppUtil.glide.load.engine.executor.FifoPriorityThreadPoolExecutor;
...
public class GlideBuilder {
     ...
     * {@link }s that are not currently in use.
     *
     ...
     * {@link }s that are not already in the cache.
     *
     * <p>
     *     Any implementation must order requests based on their {@link } for thumbnail
    ...
    /**
     * Sets the {@link ExecutorService} implementation to use when retrieving
     * {@link }s that are currently in cache.
     *
     * <p>
     *     Any implementation must order requests based on their {@link } for thumbnail
     *     requests to work properly.
