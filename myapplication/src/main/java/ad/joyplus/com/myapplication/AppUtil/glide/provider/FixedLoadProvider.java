...
/**
 * A {@link ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider} that sets the classes it provides using non null arguments in its
 * constructor.
 *
 ...
 */
public class FixedLoadProvider<A, T, Z, R> implements ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider<A, T, Z, R> {
    private final ModelLoader<A, T> modelLoader;
    private final ResourceTranscoder<Z, R> transcoder;
    private final ad.joyplus.com.myapplication.AppUtil.glide.provider.DataLoadProvider<T, Z> dataLoadProvider;
