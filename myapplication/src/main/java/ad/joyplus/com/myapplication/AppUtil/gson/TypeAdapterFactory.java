 ...
 * ad.joyplus.com.myapplication.AppUtil.gson.GsonBuilder} for them to take effect: <pre>   {@code
 *
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> ad.joyplus.com.myapplication.AppUtil.gson.TypeAdapter<T> create(Gson gson, TypeToken<T> type);
}
