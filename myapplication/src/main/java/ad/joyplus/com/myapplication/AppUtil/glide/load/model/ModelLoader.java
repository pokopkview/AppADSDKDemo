 ...
 * @param <Y> The type of the data that can be used by a {@link ad.joyplus.com.myapplication.AppUtil.glide.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@link ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
