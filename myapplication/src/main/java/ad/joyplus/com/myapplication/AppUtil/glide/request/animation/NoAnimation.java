...
/**
 * A simple {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation} that performs no actions.
 *
...
public class NoAnimation<R> implements GlideAnimation<R> {
    ...
    /**
     * A factory that always returns the same {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.NoAnimation}.
     */
    ...
    /**
     * Returns an instance of a factory that produces {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.NoAnimation}s.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns an instance of {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.NoAnimation}.
     */
    @SuppressWarnings("unchecked")
