 ...
 * remote {@link Uri}s to a wrapped {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader} that handles
 * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.GlideUrl}s.
 *
 * @param <T> The type of data that will be retrieved for {@link Uri}s.
 */
public abstract class UriLoader<T> implements ModelLoader<Uri, T> {
    private final Context context;
    private final ModelLoader<ad.joyplus.com.myapplication.AppUtil.glide.load.model.GlideUrl, T> urlLoader;

    public UriLoader(Context context, ModelLoader<ad.joyplus.com.myapplication.AppUtil.glide.load.model.GlideUrl, T> urlLoader) {
    ...
    public final DataFetcher<T> getResourceFetcher(Uri model, int width, int height) {
        ...
        if (isLocalUri(scheme)) {
            ...
            result = urlLoader.getResourceFetcher(new ad.joyplus.com.myapplication.AppUtil.glide.load.model.GlideUrl(model.toString()), width, height);
        }
