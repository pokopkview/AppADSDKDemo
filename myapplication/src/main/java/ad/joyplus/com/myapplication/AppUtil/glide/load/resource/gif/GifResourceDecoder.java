 ...
 * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.resource.gif.GifDrawable} from {@link InputStream} data.
 */
public class GifResourceDecoder implements ResourceDecoder<InputStream, ad.joyplus.com.myapplication.AppUtil.glide.load.resource.gif.GifDrawable> {
    ...
    private final ad.joyplus.com.myapplication.AppUtil.glide.load.resource.gif.GifBitmapProvider provider;
    ...
    GifResourceDecoder(Context context, BitmapPool bitmapPool, GifHeaderParserPool parserPool,
        ...
        this.provider = new ad.joyplus.com.myapplication.AppUtil.glide.load.resource.gif.GifBitmapProvider(bitmapPool);
    ...
    private GifDrawableResource decode(byte[] data, int width, int height, GifHeaderParser parser, GifDecoder decoder) {
        ...
        ad.joyplus.com.myapplication.AppUtil.glide.load.resource.gif.GifDrawable gifDrawable = new GifDrawable(context, provider, bitmapPool, unitTransformation, width, height,
