 ...
 * {@link ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.ViewPropertyAnimation} and animated
     * {@link Drawable}s).
     */
     ...
     * @param adapter The {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link View} from
     *                {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation.ViewAdapter#getView()}.
