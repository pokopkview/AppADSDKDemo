...
/**
 * A base {@link ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target} for displaying resources in
 * {@link ImageView}s.
 *
 * @param <Z> The type of resource that this target will display in the wrapped {@link ImageView}.
 */
public abstract class ImageViewTarget<Z> extends ad.joyplus.com.myapplication.AppUtil.glide.request.target.ViewTarget<ImageView, Z> implements GlideAnimation.ViewAdapter {
