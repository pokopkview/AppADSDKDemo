...
import ad.joyplus.com.myapplication.AppUtil.glide.provider.*;

import java.io.File;

/**
 * A {@link ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider} that returns classes preferentially from those set on it but
 * that also defaults to a wrapped {@link ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider} when a particular class is not set.
 *
 ...
 */
public class ChildLoadProvider<A, T, Z, R> implements ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider<A, T, Z, R>, Cloneable {
    private final ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider<A, T, Z, R> parent;
    ...
    public ChildLoadProvider(ad.joyplus.com.myapplication.AppUtil.glide.provider.LoadProvider<A, T, Z, R> parent) {
        this.parent = parent;
    }
