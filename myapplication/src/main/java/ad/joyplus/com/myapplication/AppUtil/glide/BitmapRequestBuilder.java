...
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.BitmapTransformation;
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.Downsampler;
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.StreamBitmapDecoder;
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
        extends GenericRequestBuilder<ModelType, ImageVideoWrapper, Bitmap, TranscodeType> implements ad.joyplus.com.myapplication.AppUtil.glide.BitmapOptions {
    ...
    /**
     * Transform images using {@link ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transform images using {@link ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(BitmapTransformation...)
     * @see #transform(Transformation[])
