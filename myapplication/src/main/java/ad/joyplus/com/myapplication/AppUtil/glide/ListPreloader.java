...
import ad.joyplus.com.myapplication.AppUtil.glide.request.target.BaseTarget;
import ad.joyplus.com.myapplication.AppUtil.glide.request.target.SizeReadyCallback;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a non null {@link ad.joyplus.com.myapplication.AppUtil.glide.GenericRequestBuilder} for a given item. Must exactly match
    ...
    /**
     * Constructor for {@link ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader} that requires users to subclass and override
     * the {@link #getItems(int, int)} and {@link #getRequestBuilder(Object)} methods.
     *
     * @deprecated Use {@link #ListPreloader(ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader.PreloadModelProvider,
     * ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader.PreloadSizeProvider, int)} instead. This constructor will be removed in Glide
     * 4.0.
    ...
    /**
     * Constructor for {@link ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader} that accepts interfaces for providing the dimensions of
     ...
     * </p>
     *
     * @deprecated Use {@link ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader.PreloadSizeProvider} instead. This method will be removed
     * in Glide 4.0.
     * @param item A model
     ...
     * </p>
     *
     * @deprecated Use {@link ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader.PreloadModelProvider} instead. This method will be
    ...
    private void cancelAll() {
        for (int i = 0; i < maxPreload; i++) {
            ad.joyplus.com.myapplication.AppUtil.glide.Glide.clear(preloadTargetQueue.next(0, 0));
        }
    }
