...
import ad.joyplus.com.myapplication.AppUtil.glide.util.ExceptionCatchingInputStream;
import ad.joyplus.com.myapplication.AppUtil.glide.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.ad.joyplus.com.myapplication.AppUtil.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_MOST.ad.joyplus.com.myapplication.AppUtil.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.ad.joyplus.com.myapplication.AppUtil.glide.load.data.bitmap";
        }
    };
