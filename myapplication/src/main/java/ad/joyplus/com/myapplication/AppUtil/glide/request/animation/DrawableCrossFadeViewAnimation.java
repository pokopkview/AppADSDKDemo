...
/**
 * A cross fade {@link ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation} for {@link Drawable}s
 ...
 */
public class DrawableCrossFadeViewAnimation<T extends Drawable> implements ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation<T> {
    private final ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation<T> defaultAnimation;
     ...
     */
    public DrawableCrossFadeViewAnimation(ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimation<T> defaultAnimation, int duration) {
