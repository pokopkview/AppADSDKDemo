...
import ad.joyplus.com.myapplication.AppUtil.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.MediaStoreStreamLoader;
import ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.StreamByteArrayLoader;
import ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.StreamModelLoader;
import ad.joyplus.com.myapplication.AppUtil.glide.manager.ConnectivityMonitor;
import ad.joyplus.com.myapplication.AppUtil.glide.manager.ConnectivityMonitorFactory;
...
import ad.joyplus.com.myapplication.AppUtil.glide.signature.ApplicationVersionSignature;
import ad.joyplus.com.myapplication.AppUtil.glide.signature.MediaStoreSignature;
import ad.joyplus.com.myapplication.AppUtil.glide.signature.StringSignature;
 ...
 *
 * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#with(android.app.Activity)
 * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#with(android.support.v4.app.FragmentActivity)
 * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#with(android.app.Fragment)
 * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#with(android.support.v4.app.Fragment)
 * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#with(Context)
 */
public class RequestManager implements LifecycleListener {
    ...
    private final ad.joyplus.com.myapplication.AppUtil.glide.Glide glide;
    ...
    RequestManager(Context context, final Lifecycle lifecycle, RequestManagerTreeNode treeNode,
        ...
        this.glide = ad.joyplus.com.myapplication.AppUtil.glide.Glide.get(context);
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.RequestManager}.
     */
     ...
     *
     * <p>
     *     Note - These options will be retained for the life the of this {@link ad.joyplus.com.myapplication.AppUtil.glide.RequestManager}
     *     so be wary of using
     *     {@link GenericRequestBuilder#listener(ad.joyplus.com.myapplication.AppUtil.glide.request.RequestListener)}} when
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.UriLoader}.
     */
     ...
     *     {@link ad.joyplus.com.myapplication.AppUtil.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.UriLoader}.
     */
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.DrawableRequestBuilder#signature(Key)} instead. Scheduled to be
     ...
     *
     * <p>
     *  Falls back to the registered {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoaderFactory} registered for
    ...
    public DrawableTypeRequest<Uri> fromMediaStore() {
        ModelLoader<Uri, InputStream> genericStreamLoader = ad.joyplus.com.myapplication.AppUtil.glide.Glide.buildStreamModelLoader(Uri.class, context);
        ...
        ModelLoader<Uri, ParcelFileDescriptor> fileDescriptorModelLoader =
                ad.joyplus.com.myapplication.AppUtil.glide.Glide.buildFileDescriptorModelLoader(Uri.class, context);
    ...
    /**
     * Returns a request builder that uses the {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.StreamFileLoader.Factory} and
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.StreamResourceLoader.Factory} and
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.data.HttpUrlFetcher} to load {@link URL} models.
     *
     * @see #from(Class)
     * @see #load(URL)
     *
    ...
    /**
     * Returns a request builder that uses the {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoaderFactory}s currently
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoaderFactory}s registered for the given model class for
     * {@link InputStream}s and {@link ParcelFileDescriptor}s to load a thumbnail from objects of
     * the given modelClass.
     *
     * <p>
     *     Note - you must use {@link ad.joyplus.com.myapplication.AppUtil.glide.DrawableRequestBuilder#load(Object)}} to set a concrete model
     *     to be loaded before calling
     *     {@link ad.joyplus.com.myapplication.AppUtil.glide.DrawableRequestBuilder#into(ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target)}. You may
     *     also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     *     also adjust the options after calling {@link ad.joyplus.com.myapplication.AppUtil.glide.DrawableRequestBuilder#load(Object)}} and/or
     *     {@link ad.joyplus.com.myapplication.AppUtil.glide.DrawableRequestBuilder#into(ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target)}}. However,
    ...
    private <T> DrawableTypeRequest<T> loadGeneric(Class<T> modelClass) {
        ModelLoader<T, InputStream> streamModelLoader = ad.joyplus.com.myapplication.AppUtil.glide.Glide.buildStreamModelLoader(modelClass, context);
        ModelLoader<T, ParcelFileDescriptor> fileDescriptorModelLoader =
                ad.joyplus.com.myapplication.AppUtil.glide.Glide.buildFileDescriptorModelLoader(modelClass, context);
     ...
     * {@link ad.joyplus.com.myapplication.AppUtil.glide.load.data.DataFetcher} to convert the model to.
     */
