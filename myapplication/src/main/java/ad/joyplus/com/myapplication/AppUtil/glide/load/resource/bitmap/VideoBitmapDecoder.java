...
/**
 * An {@link ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.BitmapDecoder} that can decode a thumbnail frame
...
public class VideoBitmapDecoder implements BitmapDecoder<ParcelFileDescriptor> {
    ...
    @Override
    public String getId() {
        return "VideoBitmapDecoder.ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap";
    }
