 ...
 * has been configured to {@link ad.joyplus.com.myapplication.AppUtil.gson.GsonBuilder#serializeNulls()}, these nulls will be
 * written to the final document. Otherwise the value (and the corresponding name
 * when writing to a JSON object) will be omitted automatically. In either case
 * your type adapter must handle null.
 *
 * <p>To use a custom type adapter with Gson, you must <i>register</i> it with a
 * {@link ad.joyplus.com.myapplication.AppUtil.gson.GsonBuilder}: <pre>   {@code
 *
...
public abstract class TypeAdapter<T> {
   ...
   * Unlike Gson's similar {@link ad.joyplus.com.myapplication.AppUtil.gson.Gson#toJson(ad.joyplus.com.myapplication.AppUtil.gson.JsonElement, Appendable) toJson}
   ...
   * ad.joyplus.com.myapplication.AppUtil.gson.Gson#toJson(Object) toJson} method, this write is strict. Create a {@link
   * JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call
   * {@link #write(JsonWriter, Object)} for lenient
   * writing.
   *
   ...
   *
   * @param value the Java object to convert. May be null.
   * @return the converted JSON tree. May be {@link ad.joyplus.com.myapplication.AppUtil.gson.JsonNull}.
   * @since 2.2
   */
  public final ad.joyplus.com.myapplication.AppUtil.gson.JsonElement toJsonTree(T value) {
    try {
   ...
   * similar {@link ad.joyplus.com.myapplication.AppUtil.gson.Gson#fromJson(Reader, Class) fromJson} method, this
