...
/**
 * A source encoder that writes a {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ImageVideoWrapper} to disk by preferentially
 ...
 */
public class ImageVideoWrapperEncoder implements Encoder<ad.joyplus.com.myapplication.AppUtil.glide.load.model.ImageVideoWrapper> {
    ...
    @Override
    public boolean encode(ad.joyplus.com.myapplication.AppUtil.glide.load.model.ImageVideoWrapper data, OutputStream os) {
