...
import ad.joyplus.com.myapplication.AppUtil.glide.request.target.SquaringDrawable;

/**
 * A {@link ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target} that can display an {@link android.graphics.drawable.Drawable} in
 * an {@link ImageView}.
 */
public class GlideDrawableImageViewTarget extends ad.joyplus.com.myapplication.AppUtil.glide.request.target.ImageViewTarget<GlideDrawable> {
    private static final float SQUARE_RATIO_MARGIN = 0.05f;
    private int maxLoopCount;
    private GlideDrawable resource;

    /**
     * Constructor for an {@link ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target} that can display an
