 ...
 *     }
 *     </pre>
 *     The {@link ad.joyplus.com.myapplication.AppUtil.glide.Glide#clear(ad.joyplus.com.myapplication.AppUtil.glide.request.FutureTarget)} call will make sure any resources used are recycled.
 * </p>
 *
 * @param <T> The type of the data to load.
 * @param <R> The type of the resource that will be loaded.
 */
public class RequestFutureTarget<T, R> implements ad.joyplus.com.myapplication.AppUtil.glide.request.FutureTarget<R>, Runnable {
    ...
    private R resource;
    private ad.joyplus.com.myapplication.AppUtil.glide.request.Request request;
    ...
    @Override
    public void setRequest(ad.joyplus.com.myapplication.AppUtil.glide.request.Request request) {
