 ...
 */
public class ResourceLoader<T> implements ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader<Integer, T> {
    private static final String TAG = "ResourceLoader";

    private final ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader<Uri, T> uriLoader;
    private final Resources resources;

    public ResourceLoader(Context context, ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader<Uri, T> uriLoader) {
        this(context.getResources(), uriLoader);
    }

    public ResourceLoader(Resources resources, ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader<Uri, T> uriLoader) {
