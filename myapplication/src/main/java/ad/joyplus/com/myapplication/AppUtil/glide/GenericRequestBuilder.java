...
import ad.joyplus.com.myapplication.AppUtil.glide.load.MultiTransformation;
...
import ad.joyplus.com.myapplication.AppUtil.glide.provider.ChildLoadProvider;
...
import ad.joyplus.com.myapplication.AppUtil.glide.request.GenericRequest;
import ad.joyplus.com.myapplication.AppUtil.glide.request.Request;
import ad.joyplus.com.myapplication.AppUtil.glide.request.RequestCoordinator;
import ad.joyplus.com.myapplication.AppUtil.glide.request.RequestFutureTarget;
import ad.joyplus.com.myapplication.AppUtil.glide.request.RequestListener;
import ad.joyplus.com.myapplication.AppUtil.glide.request.ThumbnailRequestCoordinator;
import ad.joyplus.com.myapplication.AppUtil.glide.request.animation.GlideAnimationFactory;
...
import ad.joyplus.com.myapplication.AppUtil.glide.request.animation.ViewPropertyAnimationFactory;
import ad.joyplus.com.myapplication.AppUtil.glide.request.target.PreloadTarget;
import ad.joyplus.com.myapplication.AppUtil.glide.request.target.Target;
import ad.joyplus.com.myapplication.AppUtil.glide.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader} will provide that
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    protected final ad.joyplus.com.myapplication.AppUtil.glide.Glide glide;
    ...
    private ad.joyplus.com.myapplication.AppUtil.glide.Priority priority = null;
    ...
    GenericRequestBuilder(Context context, Class<ModelType> modelClass,
                          ...
                          Class<TranscodeType> transcodeClass, ad.joyplus.com.myapplication.AppUtil.glide.Glide glide, RequestTracker requestTracker, Lifecycle lifecycle) {
     ...
     *     {@link ad.joyplus.com.myapplication.AppUtil.glide.load.model.ModelLoader}, {@link ResourceDecoder}, and
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> priority(
            ad.joyplus.com.myapplication.AppUtil.glide.Priority priority) {
     ...
     *
     * @see ad.joyplus.com.myapplication.AppUtil.glide.load.resource.transcode.UnitTranscoder
     * @see ad.joyplus.com.myapplication.AppUtil.glide.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see ad.joyplus.com.myapplication.AppUtil.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     * impractical to return that size from {@link Target#getSize(ad.joyplus.com.myapplication.AppUtil.glide.request.target.SizeReadyCallback)}.
     *
     ...
     * </p>
     *
     * @see ad.joyplus.com.myapplication.AppUtil.glide.signature.StringSignature
     *
     ...
     *
     * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#clear(Target)
     *
     ...
     *
     * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#clear(android.view.View)
     *
     ...
     *              {@link #override * (int, int)}} if previously called).
     *
     * @see ad.joyplus.com.myapplication.AppUtil.glide.Glide#clear(FutureTarget)
     *
     ...
     *
     *
     * @see ad.joyplus.com.myapplication.AppUtil.glide.ListPreloader
     *
     * @param width The desired width in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     *             {@link #override * (int, int)} if previously called.
     * @param height The desired height in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     ...
     *        {@link ad.joyplus.com.myapplication.AppUtil.glide.Glide#clear(Target)}.
     */
    ...
    private ad.joyplus.com.myapplication.AppUtil.glide.Priority getThumbnailPriority() {
        final ad.joyplus.com.myapplication.AppUtil.glide.Priority result;
        if (priority == ad.joyplus.com.myapplication.AppUtil.glide.Priority.LOW) {
            result = ad.joyplus.com.myapplication.AppUtil.glide.Priority.NORMAL;
        } else if (priority == ad.joyplus.com.myapplication.AppUtil.glide.Priority.NORMAL) {
            result = ad.joyplus.com.myapplication.AppUtil.glide.Priority.HIGH;
        } else {
            result = ad.joyplus.com.myapplication.AppUtil.glide.Priority.IMMEDIATE;
        }
        return result;
    }
    ...
    private Request buildRequest(Target<TranscodeType> target) {
        if (priority == null) {
            priority = ad.joyplus.com.myapplication.AppUtil.glide.Priority.NORMAL;
        }
