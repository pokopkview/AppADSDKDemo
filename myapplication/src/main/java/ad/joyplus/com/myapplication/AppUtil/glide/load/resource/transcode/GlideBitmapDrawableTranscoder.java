...
import ad.joyplus.com.myapplication.AppUtil.glide.load.resource.bitmap.GlideBitmapDrawableResource;
 ...
 */
public class GlideBitmapDrawableTranscoder implements ad.joyplus.com.myapplication.AppUtil.glide.load.resource.transcode.ResourceTranscoder<Bitmap, GlideBitmapDrawable> {
    ...
    @Override
    public String getId() {
        return "GlideBitmapDrawableTranscoder.ad.joyplus.com.myapplication.AppUtil.glide.load.resource.transcode";
    }
}
